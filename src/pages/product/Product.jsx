    ...
    try {
      ...
      await createProduct({
        createProduct: {
          ...
          thumbnail: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTst-5SxU6FwSruBjhfCLR2T7TRqaHnWuyRLQ&s",
          computerSpec: {
            processor: "N/A",
            ram: "N/A",
            storage: "N/A",
...
`;
  ...
  const filteredItems = productsData?.content.filter(item => item.name && item.name.toLowerCase().includes(filterText.toLowerCase()));
